...
class Profile(TimeStampedModel):
    ...
    gender = models.CharField(
        verbose_name="Gender", max_length=10, choices=Gender.choices, default=Gender.OTHER)
    bio = models.TextField(verbose_name=_("Bio"), blank=True, null=True)
    occupation = models.CharField(
        verbose_name="Occupation", max_length=20, choices=Occupation.choices, default=Occupation.TENANT)
